...
Usage:
    ...
    python -m control_plane.entrypoints.autonomy_tiers.main show

    # Promote a family to tier 2 (auto-execute)
    python -m control_plane.entrypoints.autonomy_tiers.main promote --family lint_fix

    # Demote a family back to tier 1 (human gate)
    python -m control_plane.entrypoints.autonomy_tiers.main demote --family lint_fix

    # Set a specific tier
    python -m control_plane.entrypoints.autonomy_tiers.main set --family observation_coverage --tier 2 --note "10 accepted proposals, 0% escalation"
"""
...
from control_plane.autonomy_tiers.config import (
    AutonomyTiersConfig,
