...
from control_plane.decision.models import ProposalCandidatesArtifact
from control_plane.insights.models import RepoInsightsArtifact
...
class ProposalCandidateLoader:
    def __init__(
        ...
        *,
        ...
        self.decision_root = decision_root or Path("tools/report/control_plane/decision")
        self.insights_root = insights_root or Path("tools/report/control_plane/insights")
