...
Compares a deployed ``control_plane.local.yaml`` against the bundled example
...
Usage::
    ...
    gaps = detect_config_drift(
        config_path="config/control_plane.local.yaml",
        example_path="config/control_plane.example.yaml",
    )
    for gap in gaps:
