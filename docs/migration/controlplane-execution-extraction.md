...
- `ExecutionService` is no longer part of the exported application surface and now lives under `control_plane.legacy_execution` as an explicit opt-in compatibility path.
